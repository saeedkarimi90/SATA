...
from domainbed import auxnet
from domainbed.lib.misc import random_pairs_of_minibatches
from domainbed.optimizers import get_optimizer

from domainbed.gradient_reversal import GradientReversal
...
class ERM(Algorithm):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        ...
        self.featurizer = auxnet.Featurizer(input_shape, self.hparams) 
    ...
    def update(self, x, y, **kwargs):
        all_x = torch.cat(x)
        all_y = torch.cat(y)
        self.featurizer.network.set_state(-1)
